...
R CMD BATCH --no-restore --no-save $HOME/whosetrait/host-micr-fitconfl_02_evoquestions_parametereffs.R $SCRATCH/parametereffs_${SLURM_ARRAY_TASK_ID}_${REP}.Rout
