...
# -- OR we can paste together genos of HOSTS and MICROBES
...
##########
#####THE FOLLOWING ARE INTERESTING SIMULATIONS BUT HIGHLY COMPUTATION INTENSIVE
##### please do not proceed without reading & understanding what will happen
##### they are mostly commented out so that no mistakes are made
##########
