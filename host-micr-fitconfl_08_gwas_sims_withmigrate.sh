...
R CMD BATCH --no-restore --no-save $HOME/whosetrait/host-micr-fitconfl_08_gwas_sims_withmigrate.R #host-micr-fitconfl_01_gwas_sims_withmigrate_simonly.Rout
...
#run models
#without K
$HOME/gemma-0.98.1-linux-static -bfile HOLOevosimsABA -lm 4 -o HOLOgemmaABA -maf 0.00125
$HOME/gemma-0.98.1-linux-static -bfile PLANTevosimsABA -lm 4 -o PLANTgemmaABA -maf 0.00125
$HOME/gemma-0.98.1-linux-static -bfile MICRevosimsABA -lm 4 -o MICRgemmaABA -maf 0.00125
$HOME/gemma-0.98.1-linux-static -bfile HOLOevosimsABO -lm 4 -o HOLOgemmaABO -maf 0.00125
$HOME/gemma-0.98.1-linux-static -bfile PLANTevosimsABO -lm 4 -o PLANTgemmaABO -maf 0.00125
$HOME/gemma-0.98.1-linux-static -bfile MICRevosimsABO -lm 4 -o MICRgemmaABO -maf 0.00125
...
#use 0.00125 to keep all alleles in the 800 exps with two or more copies in plants and 1 or more in micr
#mixed models


$HOME/gemma-0.98.1-linux-static -bfile HOLOevosimsABA -k $SCRATCH/output/holokinABA.cXX.txt -lmm 4 -o HOLOgemmaKABA  -maf 0.00125
# $HOME/gemma-0.98.1-linux-static -bfile MICRevosimsABA -k $SCRATCH/ouput/micrkinABA.cXX.txt -lmm 4 -o MICRgemmaKABA -maf 0.00125
# $HOME/gemma-0.98.1-linux-static -bfile PLANTevosimsABA -k $SCRATCH/ouput/plantkinABA.cXX.txt -lmm 4 -o PLANTgemmaKABA -maf 0.00125
#
$HOME/gemma-0.98.1-linux-static -bfile HOLOevosimsABO -k $SCRATCH/output/holokinABO.cXX.txt -lmm 4 -o HOLOgemmaKABO -maf 0.00125
# $HOME/gemma-0.98.1-linux-static -bfile MICRevosimsABO -k $SCRATCH/ouput/micrkinABO.cXX.txt -lmm 4 -o MICRgemmaKABO -maf 0.00125
# $HOME/gemma-0.98.1-linux-static -bfile PLANTevosimsABO -k $SCRATCH/ouput/plantkinABO.cXX.txt -lmm 4 -o PLANTgemmaKABO -maf 0.00125
